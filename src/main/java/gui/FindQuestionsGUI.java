...
public class FindQuestionsGUI extends JFrame {
	...
	private final JLabel lblNewLabel = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("FindQuestionsGUI.lblNewLabel.text")); //$NON-NLS-1$ //$NON-NLS-2$

	public FindQuestionsGUI(JFrame previousFrame)
	{
		try
		{
	...
	private void jbInit(JFrame previousFrame) throws Exception
	{
		...
		jLabelEvents.setBounds(292, 25, 259, 16);
