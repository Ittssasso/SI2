...
public class DataAccess {
	...
	/**
	 * This method sets as won the not-multiple bet and calls winMoney so bet
	 * winners' gain their money
	 * 
	 * @param prediction
	 * @param b
	 * @param rc
	...
	/**
	 * This method checks if the multiple bet has been won and calls winMoney so bet
	 * winners' gain their money
	 * 
	 * @param b
	 * @param rc
